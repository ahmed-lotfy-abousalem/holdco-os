...
DATA_DIR = BASE_DIR / "data" / "retail"

app = FastAPI(title="Retail Subsidiary Service")
...
def health() -> Dict[str, str]:
    return {"status": "ok", "subsidiary": "retail"}
...
def search_documents(request: DocumentSearchRequest) -> List[DocumentMatch]:
    ...
    for document in DOCUMENTS:
        ...
        if score > 0:
            ...
            matches.append(DocumentMatch(source=document.split(":")[0], snippet=snippet, score=score))
    return matches
